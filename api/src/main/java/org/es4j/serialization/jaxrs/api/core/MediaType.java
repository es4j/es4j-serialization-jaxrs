...
public class MediaType {
    ...
    //private static final HeaderDelegate<MediaType> delegate = RuntimeDelegate.getInstance()
    ...
    public boolean isCompatible(MediaType other) {
        ...
        if (type.equals(MEDIA_TYPE_WILDCARD) || other.type.equals(MEDIA_TYPE_WILDCARD)) {
            return true;
        } else if (type.equalsIgnoreCase(other.type) && (subtype.equals(MEDIA_TYPE_WILDCARD) || 
